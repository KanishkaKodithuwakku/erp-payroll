        ...
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="w-full max-w-md pt-10 mx-auto">
                    ...
                    <img src="{{ asset('tailadmin/src/images/logo/client-logo.png') }}" alt="Logo" width="200" style="margin-top: 120px;margin-left: 100px;"/>
                        ...
                        <div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mt-4 space-y-2">
                                    <x-label for="email" value="{{ __('Email') }}" class="mb-1 block text-sm font-medium text-gray-700" />
                                    <x-input id="email" class="block w-full px-4 py-2 border rounded-md" type="text" name="email"
                                        :value="old('email')" required autofocus autocomplete="username" />
                                </div>

                                <div class="mt-4 space-y-2">
                                    <x-label for="password" value="{{ __('Password') }}" class="mb-1 block text-sm font-medium text-gray-700" />
                                    <x-input id="password" class="block w-full px-4 py-2 border rounded-md" type="password" name="password"
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="absolute right-0 top-0 -z-1 w-full max-w-[250px] xl:max-w-[450px]">
                        <img src="{{ asset('tailadmin/src/images/shape/grid-01.svg') }}" alt="grid" />
                    </div>
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="#" class="block mb-4">
                            <img src="{{ asset('tailadmin/src/images/logo/auth-logo.png') }}" alt="Logo" />
                        </a>
