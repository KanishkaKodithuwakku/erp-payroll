...
<div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
    <div
        ...
        <a href="#" class="lg:hidden">
            <img class="dark:hidden" src="{{ asset('tailadmin/src/images/logo/logo.png') }}" alt="Logo" width="80"/>
            <img class="hidden dark:block" src="{{ asset('tailadmin/src/images/logo/logo.png') }}" alt="Logo" width="80"/>
        </a>
        ...
        <div class="hidden lg:block">
            Branch : {{auth()->user()->branch->branch_code}} ({{auth()->user()->branch->branch_name}})
        </div>
    </div>
