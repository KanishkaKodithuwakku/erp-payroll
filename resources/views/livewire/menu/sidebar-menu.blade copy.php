        ...
        <a href="index.html">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src="{{ asset('tailadmin/src/images/logo/logo.png') }}" width="175px;"
                    alt="Logo" />
                <img class="hidden dark:block" src="tailadmin/src/images/logo/logo-dark.png" alt="Logo" width="175px;"/>
            </span>
        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                            ...
                            :class="(selected === 'Dashboard') || (page === 'progress' || page === 'analytics' ||
                                page === 'marketing' || page === 'crm' || page === 'stocks') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Dashboard') || (page === 'progress' || page === 'analytics' ||
                                page === 'marketing' || page === 'crm' || page === 'stocks') ?
                            ...
                            <span class="menu-item-text text-sm" :class="sidebarToggle ? 'lg:hidden' : ''">
                                Dashboard
                            </span>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="#" class="menu-dropdown-item group text-sm"
                    ...
                    <!-- Menu Item Items -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Items' ? '':'Items')"
                            class="menu-item group"
                            :class="(selected === 'Items') || (page === 'addItem' ||
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Items') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden transform translate"
                            :class="(selected === 'Items') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a wire:navigate href="{{ route('items.create') }}"
                                        class="menu-dropdown-item group"
                                        :class="page === 'addItem' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Add new Item
                                    </a>
                                </li>
                                <li>
                                    <a wire:navigate href="{{ route('items') }}" class="menu-dropdown-item group"
                                        :class="page === 'itemList' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Item List
                                    </a>
                                </li>
                    ...
                    <div>
                        ...
                        <!-- Menu Item Grns -->
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'Grns' ? '':'Grns')"
                                class="menu-item group"
                                :class="(selected === 'Grns') || (page === 'addGrn' || page === 'grnList' ||
                                    page === 'returnGrn' || page === 'archivedGrns') ? 'menu-item-active' :
                                'menu-item-inactive'">
                                <svg :class="(selected === 'Grns') || (page === 'addGrn' || page === 'grnList' ||
                                    page === 'returnGrn' || page === 'archivedGrns') ?
                                'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                    :class="[(selected === 'Grns') ? 'menu-item-arrow-active' :
                                        'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                    ]"
                                    width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- Dropdown Menu Start -->
                            <div class="overflow-hidden transform translate"
                                :class="(selected === 'Grns') ? 'block' : 'hidden'">
                                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                    class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                    <li>
                                        <a wire:navigate href="{{ route('grns.create') }}"
                                            class="menu-dropdown-item group"
                                            :class="page === 'addGrn' ? 'menu-dropdown-item-active' :
                                                'menu-dropdown-item-inactive'">
                                            Add new GRN
                                        </a>
                                    </li>
                            ...
                            <div class="overflow-hidden transform translate"
                                ...
                                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                    class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                    <li>
                                        <a wire:navigate href="{{ route('grns') }}" class="menu-dropdown-item group"
                                            :class="page === 'grnList' ? 'menu-dropdown-item-active' :
                                                'menu-dropdown-item-inactive'">
                                            GRN List
                                        </a>
                                    </li>
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Suppliers' ? '':'Suppliers')"
                            class="menu-item group"
                            :class="(selected === 'Suppliers') || (page === 'addSupplier' ||
                                page === 'supplierList') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Suppliers') || (page === 'addSupplier' ||
                                page === 'supplierList') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Suppliers') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="#" class="menu-dropdown-item group"
                                        :class="page === 'addsupplier' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Add new Supplier
                                    </a>
                                </li>
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Customers' ? '':'Customers')"
                            class="menu-item group"
                            :class="(selected === 'Customers') || (page === 'addCustomer' ||
                                page === 'customerList') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Suppliers') || (page === 'addCustomer' ||
                                page === 'customerList') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Customers') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a wire:navigate href="{{ route('customers.create') }}"
                                        class="menu-dropdown-item group"
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Invoices' ? '':'Invoices')"
                            class="menu-item group"
                            :class="(selected === 'Invoices') || (page === 'addInvoice' ||
                                page === 'invoiceList' || page === 'returnInvoice' || page === 'archivedInvoices') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Invoices') || (page === 'addInvoice' ||
                                page === 'invoiceList' || page === 'returnInvoice' || page === 'archivedInvoices') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Invoices') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Menu Job Order -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'JobOrder' ? '':'JobOrder')"
                            class="menu-item group"
                            :class="(selected === 'JobOrder') || (page === 'jobOrderList' || page === 'jobOrder') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'JobOrder') || (page === 'jobOrderList' || page === 'jobOrder') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'JobOrder') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden transform translate"
                            :class="(selected === 'JobOrder') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a wire:navigate href="{{ route('job-order') }}" class="menu-dropdown-item group"
                    ...
                    <!-- Menu Item CustomerOrder -->
                    <li>
                        <a href="#"
                            @click.prevent="selected = (selected === 'CustomerOrder' ? '':'CustomerOrder')"
                            class="menu-item group"
                            :class="(selected === 'CustomerOrder') || (page === 'orderList' || page === 'addOrder') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'CustomerOrder') || (page === 'orderList' || page === 'addOrder') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'CustomerOrder') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <!-- Menu Item Stocks -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Stocks' ? '':'Stocks')"
                            class="menu-item group"
                            :class="(selected === 'Stocks') || (page === 'stockList') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Stocks') || (page === 'stockList') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Stocks') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a wire:navigate href="{{ route('stocks') }}" class="menu-dropdown-item group"
                                        :class="page === 'stockList' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Stock List
                                    </a>
                                </li>
