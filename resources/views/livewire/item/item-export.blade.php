<div class="flex space-x-3">
    ...
    {{-- <button wire:click="exportExcel"
            class="flex items-center space-x-2 bg-green-500 text-white px-4 py-2 rounded shadow hover:bg-green-600 transition" style="background-color: #465FFF">
    ...
    <!-- Export PDF Button -->
    <button style="background-color:#465FFF;padding 8px 15px;" wire:click="exportPDF"
