    ...
    <div
        ...
        <div class="flex flex-col gap-2 px-4 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ asset('documents/items.csv') }}" download="items.csv"
                    class="pt-2 pl-4 text-xs text-blue-500 transition duration-300 hover:text-blue-700 font-small"
                    style="color:#465FFF">
                    <i class="mr-1 fas fa-file-csv"></i> Download CSV
                </a>
            </div>
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
                ...
                <div class="relative">
                    ...
                    <input type="text" wire:model.live.debounce.100ms="searchTerm" placeholder="Search..."
                ...
                <livewire:item.item-import />
                <livewire:item.item-export />
        ...
        <div class="max-w-full overflow-x-auto">
            <div class="min-w-[1102px]">
                ...
                <div
                    ...
                    <div class="flex items-center col-span-2 px-4 py-3">Description</div>
                    <div class="flex items-center col-span-2 px-4 py-3">Created Date</div>
                    <div class="flex items-center col-span-1 px-4 py-3">Status</div>
                    <div class="flex items-center col-span-1 py-3">Action</div>
                </div>
                ...
                @forelse ($items as $item)
                    <div
                        ...
                        <div class="flex items-center col-span-2 px-4">{{ $item->item_description }}</div>
                        <div class="flex items-center col-span-2 px-4">{{ $item->created_at }}</div>
                        ...
                        <div class="flex items-center justify-start gap-3">
                            ...
                            <!-- View Button -->
                            <a href="{{ route('items.view', $item->id) }}" wire:navigate
                                    ...
                                    <div @click.outside="showConfirm = false"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    @click="$wire.deleteItem({{ $item->id }}); showConfirm = false"
                ...
                @empty
                    <div class="px-4 py-6 text-gray-500">No items found.</div>
                @endforelse
            </div>
        </div>
