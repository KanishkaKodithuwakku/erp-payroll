...
<div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
    ...
    <a href="#">
        <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
            <img class="dark:hidden" src="{{ asset('tailadmin/src/images/logo/logo.png') }}" alt="Logo" />
            <img class="hidden dark:block" src="{{ asset('tailadmin/src/images/logo/logo-dark.png') }}" alt="Logo" />
        </span>
                ...
                <li>
                    ...
                    <div class="overflow-hidden transform translate"
                        ...
                        <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                            ...
                            <li>
                                <a href="index.html" class="text-sm menu-dropdown-item group"
